  ...
  return (
    <div className="space-y-5 pt-2">
      <div>
        ...
        <h1 className="text-xl font-bold text-[#1A1A1A] mt-0.5">{parentName}</h1>
      </div>
      ...
      {student ? (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <p className="text-lg font-bold text-[#1A1A1A]">{student.full_name}</p>
          {group && (
            <>
              <p className="text-sm text-gray-500 mt-1">{t('portalGroup')}: <span className="font-medium text-[#1A1A1A]">{group.name}</span></p>
      ...
      {recentAttendance.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/ota-ona/davomat" className="text-xs text-[#F5B800]">Barchasi &rarr;</Link>
          </div>
      ...
      {recentPayments.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/ota-ona/tolovlar" className="text-xs text-[#F5B800]">Barchasi &rarr;</Link>
          </div>
          <div className="space-y-2">
