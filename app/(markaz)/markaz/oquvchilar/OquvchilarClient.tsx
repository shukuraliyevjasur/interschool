  ...
  return (
    <>
      ...
      <div className="flex gap-3 mb-5 flex-wrap">
        <input
          className="flex-1 min-w-48 px-4 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-[#F5B800]"
                ...
                <tr key={s.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-5 py-3">
                    <div className="flex gap-2 justify-end">
                      <button onClick={() => setEditStudent(s)} className="text-xs text-gray-400 hover:text-[#D4970A] transition-colors">Tahrirlash</button>
        ...
        <Modal title="Yangi kirish kodi" onClose={() => setRevealedCode(null)}>
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-4 text-center">
              <p className="text-3xl font-mono font-bold tracking-widest text-[#1A1A1A]">{revealedCode.code}</p>
            </div>
